...
function salaryCal() {
  ...
  document.getElementById("finalSalary").innerHTML =
    salaryPerHour * totalWorkingHour;
}
...
function currencyConvert() {
  ...
  document.getElementById("vndResult").innerHTML = usdToVnd.format(
